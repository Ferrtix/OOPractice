...
public class TabulatedFunctionFileOutputStream {
    public static void main(String[] args) {
        try(
             BufferedOutputStream arrFileOut = new BufferedOutputStream(new FileOutputStream("E:\\учеба\\java\\OOPractice\\output\\array functions.bin"));
             BufferedOutputStream listFileOut = new BufferedOutputStream(new FileOutputStream("E:\\учеба\\java\\OOPractice\\output\\linked list functions.bin"))) {
